...
export class WeekService {
  ...
  public static getSeasonWeek(): number {
    const seasonEpoch = parseISO('2022-08-23T17:00:00Z'); // #UPDATEME parseISO('2022-05-24T17:00:00Z'); 
  ...
  public async getLostSectors(delta?: number): Promise<LostSectors> {
    ...
    const lsEpoch = parseISO('2022-05-24T17:00:00.000Z'); // 2021-08-24 is our current reference date
