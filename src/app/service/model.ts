...
export class Const {
    ...
    public static readonly LIGHT_TOO_LOW = 1519; // 1509; // #UPDATEME  -61 from pinnacle in the past
    private static readonly SEASON_SOFT_CAP = 1520; // 1510; // #UPDATEME
    // legendary campaign reward 1520
    public static readonly SEASON_HARD_CAP = 1570; // 1560; // #UPDATEME
    public static readonly SEASON_PINNACLE_CAP = 1580; // 1570; // #UPDATEME
