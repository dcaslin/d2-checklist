...
import { PlayerComponent, BurnDialogComponent } from './player/player.component';
...
import { BountiesComponent, QuestDialogComponent } from './player/bounties/bounties.component';
